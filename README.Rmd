...
**Note:** Especially when working with large datasets, reading data from Voteview can take a long time.
...
You may also use `mirai` to download Voteview data in parallel. See `vignette("parallel-downloads", package = "filibustr")` for more info on parallel data downloads.
