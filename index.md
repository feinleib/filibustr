...
- You may use `mirai` to download Voteview data in parallel. See
  ...
  for more info on parallel data downloads.
...
Effective Lawmaking](https://thelawmakers.org).

Here is an example table returned by
[`get_les()`](https://feinleib.github.io/filibustr/reference/get_les.md).
...
retrives replication data for [Harbridge-Yong, Volden, and Wiseman
(2023)](https://doi.org/10.1086/723805).

Here are the tables returned by
[`get_hvw_data()`](https://feinleib.github.io/filibustr/reference/get_hvw_data.md):
...
- [`get_senate_sessions()`](https://feinleib.github.io/filibustr/reference/get_senate_sessions.md):
  The start and end dates of each legislative session of the Senate.
  ([table
  link](https://www.senate.gov/legislative/DatesofSessionsofCongress.htm))
- [`get_senate_cloture_votes()`](https://feinleib.github.io/filibustr/reference/get_senate_cloture_votes.md):
  Senate actions on cloture motions and cloture votes. ([table
...
- 3 functions dealing with years and Congress numbers:
  - [`year_of_congress()`](https://feinleib.github.io/filibustr/reference/year_of_congress.md)
    returns the starting year for a given Congress.
  - [`congress_in_year()`](https://feinleib.github.io/filibustr/reference/congress_in_year.md)
  ...
  - [`current_congress()`](https://feinleib.github.io/filibustr/reference/current_congress.md)
    returns the number of the current Congress, which is currently 119.
    [`current_congress()`](https://feinleib.github.io/filibustr/reference/current_congress.md)
    is equivalent to `congress_in_year(Sys.Date())`.
- [`get_voteview_cast_codes()`](https://feinleib.github.io/filibustr/reference/get_voteview_cast_codes.md)
  returns a key to the `cast_code` column in
  [`get_voteview_member_votes()`](https://feinleib.github.io/filibustr/reference/get_voteview_member_votes.md).
- [`read_html_table()`](https://feinleib.github.io/filibustr/reference/read_html_table.md)
  is a general-use function for reading HTML tables from online. It’s a
  nice shortcut for a common `rvest` workflow that otherwise takes 3
  functions. (It’s what powers the Senate.gov functions!)
